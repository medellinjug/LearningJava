...
//Get developer for first name
    ...
    public ResponseEntity getDeveloperForLastName(@PathVariable String lastName) {

        List<Developer> matchList= developerServiceBean.getDeveloperssFoLastName(lastName);
